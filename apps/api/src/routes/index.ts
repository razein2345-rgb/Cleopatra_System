...
import { extraServiceOptionsRouter } from './extraServiceOptions.js';
import { digitalPriceTiersRouter } from './digitalPriceTiers.js';
...
import { treasuryCategoriesRouter } from './treasuryCategories.js';
...
api.use('/extra-service-options', extraServiceOptionsRouter);
api.use('/digital-price-tiers', digitalPriceTiersRouter);
api.use('/quotations', quotationsRouter);
api.use('/orders', ordersRouter);
api.use('/order-templates', orderTemplatesRouter);

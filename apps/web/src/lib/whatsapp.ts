 ...
 *
 * An optional `message` pre-fills the WhatsApp compose box via wa.me's
 * `text` param — it still lands as a draft the staff member reviews and
 * presses send on themselves, never an automatic/silent send.
 */

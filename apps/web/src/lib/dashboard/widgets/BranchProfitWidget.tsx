        ...
        <div className="space-y-3">
          ...
          {summary.hasUnknownProfitItems && (
            <p className="text-muted-foreground text-xs">
              ⚠ فيه أصناف (منتجات جاهزة/بضاعة مخزون) مالهاش سعر تكلفة مسجّل بعد — صافي الربح المعروض أقل من الحقيقي
              لحد ما يتسجّل سعر التكلفة بتاعها من شاشة المخزون/المنتجات الجاهزة.
            </p>
          )}
        </div>
      )}

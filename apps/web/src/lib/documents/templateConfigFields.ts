...
export const TEMPLATE_CONFIG_FIELDS: TemplateConfigFieldDef[] = [
  ...
  { key: 'showBusinessLandline', label: 'إظهار الرقم الأرضي', type: 'boolean' },
  { key: 'showBusinessFacebook', label: 'إظهار صفحة الفيسبوك', type: 'boolean' },
...
export const DEFAULT_TEMPLATE_CONFIG: DocumentTemplateConfig = {
  ...
  showBusinessLandline: true,
  showBusinessFacebook: true,
  showTaxNumber: false,

...
const FIELD_GROUPS: Array<{ title: string; fields: FieldDef[] }> = [
  {
    ...
    fields: [
      ...
      // Owner (2026-08-27) — تكلفة المورد الحقيقية، منفصلة عن zincPrice فوق
      // (سعر التسعير المُضاف عليه هامش الربح بعد كده) — أساس حساب "فرق
      // السعر والربح". اسم المورد نفسه مش مكتوب هنا عمدًا (owner: "مينفعش
      // تكتبلي إسم المورد... ممكن يتغير المورد ده") — الرقم مستقل تمامًا عن
      // هوية المورد، وقابل للتغيير بحرية وقت ما يتغيّر المورد.
      { key: 'zincSupplierCost', label: 'تكلفة الزنكات من المورد الحالي' },
